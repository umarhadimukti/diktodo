        ...
        <nav x-data="{
          ...
          <div class="relative">
            <ul
              ...
              <li>
                <button
                  :class="{ 'bg-purple-300' : navigationMenu=='getting-started', 'hover:bg-purple-500' : navigationMenu!='getting-started' }"
                  @mouseover="navigationMenuOpen=true; navigationMenuReposition($el); navigationMenu='getting-started'"
                  @mouseleave="navigationMenuLeave()"
                  class="inline-flex items-center justify-center h-7 px-4 py-2 text-sm font-medium transition-colors rounded-md hover:text-slate-400  font-inconsolata  focus:outline-none disabled:opacity-50 disabled:pointer-events-none group w-max">
              ...
              <div x-show="navigationMenu == 'getting-started'"
                ...
                <div class="w-30 font-inconsolata">
                  <a href="#_" @click="navigationMenuClose()" class="block text-sm rounded hover:bg-neutral-100">
                    <a href="{{ route('user.todo.profile') }}" class="px-2 py-1 rounded font-bold">My
                      Profile</a>
