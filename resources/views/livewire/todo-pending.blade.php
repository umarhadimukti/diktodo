                ...
                <template x-teleport="body">
                    <div x-show="modalOpen"
                        ...
                        <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                            ...
                            <form wire:submit.prevent="update()" class="relative w-auto pb-8">
                                <div class="mb-3">
                                ...
                                <div class="mb-3 flex items-center gap-1">
                                    <input wire:model="status" type="checkbox" id="status" @if ($task->status ==
                                    'completed') checked @else unchecked @endif value="{{ $task->status }}">
                ...
                <template x-teleport="body">
                    <div x-show="modalOpen"
                        ...
                        <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                            ...
                            <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                                <form action="{{ route('user.todo.tasks.destroy', $task->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
