                            ...
                            <div x-show="modalOpen"
                                ...
                                <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                                    ...
                                    <div class="relative w-auto pb-8">
                                        <div class="input-area mb-2">
                                            ...
                                            <div class="flex gap-1">
                                                <input wire:model.defer="current_password" @if($show_password !=true)
                                    ...
                                    <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2">
                                        ...
                                        <button wire:click.prevent="update_password" @if($error_password)
                                            @click="modalOpen=true" @else @click="modalOpen=false" @endif type="button"
                                            class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium text-white transition-colors border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-2 bg-neutral-950 hov
                                            er:bg-neutral-900">Change</button>
                                    </div>
                                </div>
                            </div>
                            {{--
