      ...
      <div class="max-w-content flex w-max items-center">
        <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false" :class="{ 'z-40': modalOpen }"
          ...
          <button @click="modalOpen=true"
            class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium transition-colors text-slate-500 rounded-md hover:bg-red-400 hover:text-slate-200 active:red-500 focus:bg-red-400 focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
